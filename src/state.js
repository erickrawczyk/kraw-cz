...
const STATE = [
  ...
  },
  {
    ...
    title: "Hey, I'm Eric!",
    contents: [
      <p>I'm a software developer from Ann Arbor, Michigan!</p>,
      <p>
        I spend a lot of time building things in JavaScript, but I'm pretty
        flexible. I love making web applications from the ground up, jumping
        into every layer of the stack. If you're interested in tech, music, or
        theatre, let's chat!
      </p>
    ]
  },
  {
    ...
    contents: [
      <p>
        ...
        , a data and robotics startup that builds drones to inspect wind
        turbines, and software to track damage in turbine fleets.
      </p>,
      <p>
        Previously, I've worked at&nbsp;
        <a
          href="http://deepfield.com"
          target="_blank"
          rel="noopener noreferrer"
        >
          Deepfield
  ...
  },
  {
    ...
    contents: [
      <p>
        I'm always learning new things, but here are the tools I'm most familiar
        with.
      </p>
    ],
    icons: [
  ...
  },
  {
    ...
    contents: [
      <p>
        I always prefer real human conversation to internet snooping. If you
        want to know more about web development, need someone for a project, or
