/**
 * Thanks to Pawel Grzybek for his smooth scrolling tutorial
...
/**
 * @param {string} trigger - Clickable element to trigger scrolling (querySelector string)
 * @param {string} destination - Destination to scroll to (querySelector string)
 */
function smoothScroll(trigger , destination) {
  if (!trigger || !destination) return;
  document.querySelector(trigger).addEventListener('click', () => {
    scrollIt(document.querySelector(destination), 300, 'easeInOutCubic');
  });
}
