  ...
  return (
    <div>
      ...
      <a
        ...
        className="group mt-2 inline-flex items-center gap-2 font-display text-3xl font-semibold text-white transition-colors hover:text-violet-200 md:text-4xl"
      >
        {job.company}
      ...
      {job.milestone && (
        <div className="mt-3 inline-flex rounded-full border border-violet-400/25 bg-violet-400/10 px-3 py-1 text-xs text-violet-200">
          {job.milestone}
        </div>
      )}
    </div>
